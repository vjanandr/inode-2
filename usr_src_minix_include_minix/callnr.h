...
#define VFS_FILEINFO        (VFS_BASE + 49)
#define VFS_FBLOCKS         (VFS_BASE + 50)
#define GET_FS_STAT         (VFS_BASE + 51)
#define DELINODEZONE        (VFS_BASE + 52)
#define RECINODE             (VFS_BASE + 53)


#define NR_VFS_CALLS		54	/* highest number from base plus one */
